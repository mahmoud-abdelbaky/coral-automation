...
public class addTPAEntity extends pageBase {
    private static String type_name;
    public addTPAEntity(WebDriver driver) {
        super(driver);
    ...
    @FindBy(xpath="(//input[contains(@class,'mat-input-element')])[1]") WebElement Name;
    @FindBy(xpath="(//input[contains(@class,'mat-input-element')])[2]") WebElement Email;
    @FindBy(xpath="(//input[contains(@class,'mat-input-element')])[3]") WebElement Billing_Email;
    ...
    @FindBy(xpath="//*[contains(@class, 'mat-tab-body')]/div/locations-info/div/kendo-grid/div/kendo-grid-list/div/div[1]/table/tbody/tr[1]/td[9]/kendo-dropdownlist") WebElement location_state;
   ...
   /* public void provider(String npi_value,
    ...
    public void tpa(String ventanex_value, String ventanex_api) throws InterruptedException
    {
        ...
        if(type_name.equalsIgnoreCase("tpa"))
        {
            ...
            text(ventanex_api_key, ventanex_api);
        }
